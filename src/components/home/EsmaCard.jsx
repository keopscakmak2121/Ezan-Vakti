...
const EsmaCard = ({ darkMode }) => {
  ...
  return (
    <div style={cardStyles}>
      ...
      {dailyEsma ? (
        <div>
          <p style={{ fontSize: '22px', fontWeight: 'bold', fontFamily: 'Amiri', textAlign: 'right' }}>{dailyEsma.arabic}</p>
          <p style={{ fontSize: '18px', fontWeight: '600', marginTop: '10px' }}>{dailyEsma.name}</p>
